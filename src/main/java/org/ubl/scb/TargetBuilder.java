...
public class TargetBuilder {
     ...
     * @param config config
     */
    public TargetBuilder(final Config config) {
        this.config = config;
    }
    ...
    public List<TemplateTarget> buildCanvases() {
        ...
        final List<VPMetadata> inputList = vi.processInputFile(TargetBuilder.class.getResourceAsStream(config
                .getMetadataFile()));
        ...
        final Iterator<Dimension> i3 = Objects.requireNonNull(dims)
                .iterator();
