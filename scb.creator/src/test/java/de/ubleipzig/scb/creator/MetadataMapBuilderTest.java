...
public class MetadataMapBuilderTest {
    ...
    void testBuildMetadataMap() {
        ...
        while (i1.hasNext() && i2.hasNext()) {
            ...
            final Optional<String> t1 = ofNullable(vp.getGroupTag1());
            t1.ifPresent(s -> tags.put("tag1", s));
            final Optional<String> t2 = ofNullable(vp.getGroupTag2());
            t2.ifPresent(s -> tags.put("tag2", s));
            final Optional<String> t3 = ofNullable(vp.getGroupTag3());
            t3.ifPresent(s -> tags.put("tag3", s));
            final Optional<String> t4 = ofNullable(vp.getGroupTag4());
            t4.ifPresent(s -> tags.put("tag4", s));
            final Optional<String> t5 = ofNullable(vp.getGroupTag5());
            t5.ifPresent(s -> tags.put("tag5", s));
            final Optional<String> t6 = ofNullable(vp.getGroupTag6());
            t6.ifPresent(s -> tags.put("tag6", s));
            final Optional<String> t7 = ofNullable(vp.getGroupTag7());
            t7.ifPresent(s -> tags.put("tag7", s));
            final Optional<String> t8 = ofNullable(vp.getGroupTag8());
